...
import { BoardWorld } from '@/ar/board/BoardWorld'
import { boardMembers, getBoardMemberIndex } from '@/data/boardMembers'
...
export class BoardController {
  ...
  private world = new BoardWorld()
  private raycaster = new THREE.Raycaster()
  private pointer = new THREE.Vector2()
  private clock = new THREE.Clock()
  private running = false
  private raf = 0
  private phase: BoardPhase = 'boot'
  private phaseTime = 0
  private hoveredId: string | null = null
  private selectedId: string | null = null
  private selectedIndex = -1
  private hooks: BoardControllerHooks = {}
  ...
  setHooks(hooks: BoardControllerHooks): void {
    this.hooks = hooks
  }
  ...
  selectByIndex(index: number): void {
    const clamped = (index + boardMembers.length) % boardMembers.length
  ...
  private setPhase(phase: BoardPhase): void {
    this.phase = phase
    this.phaseTime = 0
