...
export const en = {
  ...
  tacticsTitle: 'GOLDEN ERA TACTICS',
  legendsTabProfiles: 'PROFILES',
  legendsTabTactics: 'TACTICS',
  tacticsHint: 'Tap a player to see their role in the setup.',
  tacticsNote:
    'Golden Era line-ups reconstructed from public match records — replace with official club data.',
} as const
